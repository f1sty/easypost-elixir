defmodule Easypost.Batch do
  ...
  def create_batch(conf, shipments) do
    ...
    case Requester.request(
           :post,
           Helpers.url(conf[:endpoint], "/batches"),
           conf[:key],
           [],
           ctype,
           body
  ...
  def create_and_buy_batch(conf, shipments) do
    ...
    case Requester.request(
           :post,
           Helpers.url(conf[:endpoint], "/batches/create_and_buy"),
           conf[:key],
           [],
           ctype,
           body
  ...
  def batch_labels(conf, batch_id, label) do
    ...
    case Requester.request(
           :post,
           Helpers.url(conf[:endpoint], "/batches/" <> batch_id <> "/label"),
           conf[:key],
           [],
           ctype,
           body
  ...
  def add_to_batch(conf, batch_id, shipments) do
    ...
    case Requester.request(
           :post,
           Helpers.url(conf[:endpoint], "/batches/" <> batch_id <> "/add_shipments"),
           conf[:key],
           [],
           ctype,
           body
  ...
  def remove_from_batch(conf, batch_id, shipments) do
    ...
    case Requester.request(
           :post,
           Helpers.url(conf[:endpoint], "/batches/" <> batch_id <> "/remove_shipments"),
           conf[:key],
           [],
           ctype,
           body
