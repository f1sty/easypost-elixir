defmodule Easypost.Shipment do
  ...
  def create_shipment(conf, shipment) do
    ...
    case Requester.request(
           :post,
           Helpers.url(conf[:endpoint], "/shipments"),
           conf[:key],
           [],
           ctype,
           body
  ...
  def refund_usps_label(conf, shipment_id) do
    ...
    case Requester.request(
           :get,
           Helpers.url(conf[:endpoint], "/shipments/" <> shipment_id <> "/refund"),
           conf[:key],
           [],
           ctype,
           body
  ...
  def insure_shipment(conf, shipment_id, insurance) do
    ...
    case Requester.request(
           :post,
           Helpers.url(conf[:endpoint], "/shipments/" <> shipment_id <> "/insure"),
           conf[:key],
           [],
           ctype,
           body
  ...
  def buy_shipment(conf, shipment_id, rate) do
    ...
    case Requester.request(
           :post,
           Helpers.url(conf[:endpoint], "/shipments/" <> shipment_id <> "/buy"),
           conf[:key],
           [],
           ctype,
           body
